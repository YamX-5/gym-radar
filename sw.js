...
const CACHE = 'gym-radar-v5';
const ASSETS = [
  './', './index.html',
  './css/app.css',
  './js/config.js', './js/store.js', './js/supabase-adapter.js', './js/seed.js', './js/domain.js', './js/bot.js', './js/wa.js', './js/importer.js', './js/checkin.js', './js/app.js',
